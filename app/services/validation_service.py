        ...
        try:
            ...
            for record in records:
                history_data.append({
                    ...
                    "s3_validation_image_url": self.storage_service.build_record_url(record["uuid"], record["input_image_filename"]),
                    "s3_mask_url": self.storage_service.build_record_url(record["uuid"], "mask.png")
                })
    ...
    async def get_validation_record_by_uuid(self, validation_uuid: str, access_token: str) -> BaseResponse:
        ...
        try:
            ...
            record_data = {
                ...
                "validation_algorithm": record["validation_algorithm"],
                "validation_time": record["time_created"].isoformat(),
                "s3_path": self.storage_service.build_record_url(record["uuid"], record["input_image_filename"]),
                "s3_mask_url": self.storage_service.build_record_url(record["uuid"], "mask.png")
            }
